...
(function () {
  ...
  var embedUrl = (script && script.dataset && script.dataset.embedUrl) || "https://liberty-frontend-1sud.vercel.app/embed";
  var launcherText = (script && script.dataset && script.dataset.launcherText) || "Ask Liberty";
  ...
  panel.style.boxShadow = "0 24px 80px rgba(15, 39, 71, 0.18)";
  panel.style.background = "white";
  panel.style.display = "none"; // ✅ Starts hidden
